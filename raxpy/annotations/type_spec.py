from typing import Optional, List, Union, Generic, TypeVar, Any, Callable, Type, Dict, get_origin, get_type_hints, get_args
...
def list_dataclass_attributes(cls):
    ...
    for attr in attributes:
        t = attr.type
        child_dim = map_type(attr.name, t, UndefinedValue if attr.default == MISSING else attr.default)
