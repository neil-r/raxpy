...
def generate_design(space:InputSpace, n_points:int, base_creator=_default_base_lhs_creator) -> DesignOfExperiment:
  ...
  design_request_stack:List[Tuple[Optional[Dimension],List[Dimension]]] = [(None,list(create_level_iterable(space.children)))]
